window.skins={};
	...
	function GameSceneSkin() {
		_super.call(this);
		this.skinParts = ["beginBtn","welcomeGroup","collectionBtn","collectionGroup","picContainer","animationGroup"];
		
		this.height = 1334;
		this.width = 750;
		this.elementsContent = [this.welcomeGroup_i(),this.collectionGroup_i(),this.animationGroup_i()];
	}
	...
	_proto.collectionGroup_i = function () {
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this.collectionBtn_i()];
		return t;
	};
	...
	_proto.animationGroup_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._Label2_i(),this.picContainer_i()];
		return t;
	};
